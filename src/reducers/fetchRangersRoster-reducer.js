...
export default function reducer (state = {
    ...
    switch(action.type) {
        ...
        case "FETCH_PLAYER_STATS_BY_YEAR": {
          return {
            ...state,
            fetching: true
          }
        }
        case "FETCH_PLAYERS_STATS_BY_YEAR_REJECTED": {
          return {
            ...state,
            fetching: false,
            error: action.payload
        ...
        case "FETCH_PLAYERS_STATS_BY_YEAR_FULFILLED": {
          return {
            ...state,
            fetching: false,
            fetched: true,
            playerStats: action.payload.stats[0].splits[0].stat,
